//
// Generated file, do not edit! Created by nedtool 5.6 from veins/modules/messages/BasicSafetyMessage.msg.
//
...
BasicSafetyMessage::BasicSafetyMessage(const char *name, short kind) : ::Veins::WaveShortMessage(name,kind)
{
}

BasicSafetyMessage::BasicSafetyMessage(const BasicSafetyMessage& other) : ::Veins::WaveShortMessage(other)
{
    copy(other);
}
...
BasicSafetyMessageDescriptor::BasicSafetyMessageDescriptor() : omnetpp::cClassDescriptor("Veins::BasicSafetyMessage", "Veins::WaveShortMessage")
{
