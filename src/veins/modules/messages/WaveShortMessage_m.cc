//
// Generated file, do not edit! Created by nedtool 5.6 from veins/modules/messages/WaveShortMessage.msg.
//
...
WaveShortMessageDescriptor::WaveShortMessageDescriptor() : omnetpp::cClassDescriptor("Veins::WaveShortMessage", "omnetpp::cPacket")
{
