//
// Generated file, do not edit! Created by nedtool 5.6 from veins/modules/messages/WaveServiceAdvertisement.msg.
//
...
WaveServiceAdvertisment::WaveServiceAdvertisment(const char *name, short kind) : ::Veins::WaveShortMessage(name,kind)
{
    this->targetChannel = 0;
}

WaveServiceAdvertisment::WaveServiceAdvertisment(const WaveServiceAdvertisment& other) : ::Veins::WaveShortMessage(other)
{
    copy(other);
}
...
WaveServiceAdvertismentDescriptor::WaveServiceAdvertismentDescriptor() : omnetpp::cClassDescriptor("Veins::WaveServiceAdvertisment", "Veins::WaveShortMessage")
{
